...
public class Controller {
    ...
    private LogScreenJFrame basicLogScreen;
    private ChampignonScreenJFrame champignonScreen;
    ...
    //Big Switch Case
    private void parseLineAndHandleEvents(String line){
    ...
    //Switch case Events
    private void handleLoadGameEvent(String line){
    ...
    private void handleLoadoutEvent(String line){
        ...
        */
        ...
        currentJumpMaxFuelCost = FSD_FUEL_MAP.get(fsdModel);
    }
    private void handleLocationEvent(String line){
        /*{
    ...
    private void handleScanEvent(String line){
    ...
    private void handleFSDJumpEvent(String line){
        /*{
    ...
    private void handleFSSSignalDiscoveredEvent(String line){
